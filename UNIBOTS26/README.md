# UniBots UK Regionals: The "Pivot" Robot | 🥉 3rd Place
*Representing Imperial College London at the Cambridge Regionals (35 Teams).*
...
* **Timelines:** I, alongside certain teammates, bridged the gap between half-built prototypes and hard deadlines by taking on additional tasks to ensure the project remained on track.
* **Adaptability:** Successfully managed the morale shift required to scrap months of mechanical work for a simplified, winning strategy on game day.
